    ...
    useEffect(() => {
        getRunningTrips().then(response => {
            if (response.status === 200) {
                ...
                const tataSanandTrips = runningTrips.filter(data => data?.origin.toLowerCase().includes('sanand'.toLowerCase()) && data?.consignorName.toLowerCase().includes('tata'.toLowerCase()));
